...
export async function checkDailyBudget(userId, tier) {
  const caps = {
    free: parseFloat(process.env.AI_COST_CAP_FREE || '0.50'),
    abo: parseFloat(process.env.AI_COST_CAP_ABO || '5.00'),
    premium: parseFloat(process.env.AI_COST_CAP_PREMIUM || '15.00'),
  };
