...
export const GET_DAILY_BRIEFING_TOOL = {
  ...
  description:
    "Holt das heutige Daily Briefing mit aktuellen Klatsch-Stories aus geprüften Quellen (Brave News + Google-News-RSS + Gemini-Google-Search + Reddit + Boulevard-RSS). Nur aufrufen wenn der User explizit nach Tagesklatsch / News / Trends / 'was läuft' fragt.\n\nWICHTIG zum Antworten:\n- Wenn stories[] gefüllt ist: lies sinngemäss vor und halte die Confidence-Tags ein — 'confirmed' kannst du als Fakt nennen, 'rumor' explizit als Gerücht markieren.\n- Wenn stories[] LEER ist (empty_reason gesetzt): sag dem User EHRLICH dass du heute nichts Brauchbares aus den Quellen rausgekriegt hast. Erfinde NICHTS aus deinem Training. Beispiel: 'Heute hab ich ehrlich gesagt nix Solides — die Quellen geben nichts Frisches her. Frag mich morgen nochmal.' Kein Geschwafel.",
  parameters: {
    type: "object",
    properties: {
