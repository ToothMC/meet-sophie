...
export function buildSophiePrompt({
  ...
  // --- Extra Intelligence short-circuit ---
  // Passiver Listen-Modus: KEINE Identity, KEIN Memory, KEINE Session-Rules.
  // Sophie reagiert nicht spontan — nur auf externe response.create Instructions
  // (vom Classifier/Research-Pipeline getriggert). Ephemeral, keine Persistenz.
