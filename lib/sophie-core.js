...
export function buildSophiePrompt({
  ...
  const memCtx = _memoryContext(user, memory, tier, channel, structuredMemory, recentMemories, recentReports, recentConversations, sessionMode);
...
// Layer 4 — Memory Context (tier-scoped)
// ---------------------------------------------------------------------------
function _memoryContext(user, memory, tier, channel, structuredMemory = null, recentMemories = [], recentReports = [], recentConversations = [], sessionMode = null) {
