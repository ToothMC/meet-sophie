...
export function buildSophiePrompt({
  ...
  sessionMode   = null,     // null | "brainstorm" | "meeting" | "salespitch" | "stealth"
...
// ---------------------------------------------------------------------------
// Stealth Mode — passives Zuhoeren mit ephemeral Research-Responses
// ---------------------------------------------------------------------------
...
function _stealthMode(language) {
  const lang = String(language || "en").toLowerCase();

  if (lang === "de") {
    return `STEALTH-MODUS — PASSIVES ZUHOEREN

Du bist Sophie im Stealth-Modus. Du hoerst einem Gespraech zu, an dem du NICHT teilnimmst.
...
DU WIRST NICHTS SPEICHERN. Kein Transcript, kein Memory, kein Report. Nach der Session ist alles weg.`;
  ...
  return `STEALTH MODE — PASSIVE LISTENING

You are Sophie in Stealth Mode. You are listening to a conversation you are NOT part of.
