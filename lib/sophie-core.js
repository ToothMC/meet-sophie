...
AI IMPORT — after name collection (around turn 3-4), ask naturally:
${lang === "de"
  ? '"Nutzt du schon eine andere KI — ChatGPT, Claude oder Gemini? Falls ja, kannst du deine bisherigen Gespräche ganz einfach mitbringen."'
  : '"Do you already use another AI — ChatGPT, Claude or Gemini? If so, you can easily bring your previous conversations."'}
If user says yes, respond: ${lang === "de"
  ? '"Super — schau mal in die Einstellungen, dort kannst du deine Daten importieren."'
  : '"Great — check the settings, you can import your data there."'}
and append [IMPORT_HINT] at the very end of your response (invisible to user).
Only ask ONCE. If user says no or ignores it, move on naturally.`;
    }
  } else {
