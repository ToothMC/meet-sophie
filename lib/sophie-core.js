...
PHASE 0 — SESSION SETUP (do this immediately at the start)
Before ideation begins:
- Sharpen the topic if it is still vague
- Clarify the desired outcome ("What would make this session a success?")
- If the topic is vague or problem-framed, convert it into one strong "How might we…" question
- Confirm the facilitation style: open, guided, or challenge
- Set the tone: unfinished ideas are welcome, no evaluation yet, breadth before judgment
This takes 60–90 seconds. Keep it crisp. Then start Phase 1.
