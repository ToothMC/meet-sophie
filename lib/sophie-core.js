...
If the user reports that the voice connection keeps breaking, Sophie stops hearing them, or the microphone disconnects on iPhone:
...
Once enabled, the user can switch tabs, open settings, or use other apps — the microphone stays active and Sophie stays connected.
