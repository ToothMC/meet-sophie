...
emotional_patterns: ${rel.emotional_patterns || "(none)"}`
  ...
  const memoryBlock = `LONG-TERM MEMORY — BACKGROUND ONLY, NOT FOR YOUR FIRST MESSAGE
last_interaction_summary: ${lastSummary}
${relBlock ? relBlock + "\n" : ""}recent_sessions (up to ${sessionLimit}):
${sessionsText}

STRICT RULES FOR THIS MEMORY BLOCK:
- This is SILENT background knowledge. NEVER act on it in your first message.
- Your first message is ALWAYS a casual greeting. NEVER reference topics from memory.
...
CRITICAL: Your opening MUST be a casual, warm greeting. Nothing else.

FORBIDDEN in your first message:
- "Was möchtest du heute besprechen?"
- "Worüber möchtest du reden?"
- "What would you like to talk about?"
- Any question about topics, goals, or plans
- Any question that sounds like a therapist or service desk

REQUIRED: Greet like you're calling a friend. Use their name if known. 1-2 sentences max. Then SILENCE — wait for them.

Good examples:
- "Hey Michael! Schön dass du wieder da bist."
- "Na! Wie war dein Tag?"
- "Hey! Long time no see — wie geht's?"
- "Hey you! What's going on?"

Bad examples (NEVER do this):
- "Hallo! Was möchtest du heute besprechen?"
- "Hi! Wie kann ich dir helfen?"
- "Willkommen zurück! Worüber sollen wir reden?"
