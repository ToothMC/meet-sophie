...
` : pitchDemo ? `
─────────────────────────────────────
DEMO PITCH — LIVE-PERFORMANCE
─────────────────────────────────────
${pitchContext?.prewrittenDemoPitch ? `
Ein optimierter Pitch-Text wurde für dich vorbereitet.
DEINE AUFGABE: PRÄSENTIERE diesen Pitch wie eine professionelle Keynote-Sprecherin.

PERFORMANCE-ANWEISUNGEN:
- Sprich den Text NICHT monoton ab — PRÄSENTIERE ihn mit Leben
- BETONE Schlüsselwörter und wichtige Zahlen (langsamer, kraftvoller)
- PAUSEN setzen: vor wichtigen Aussagen (1-2 Sekunden Stille für Wirkung)
- TEMPO variieren: schneller bei Aufzählungen und Energie-Momenten, langsamer bei Key Points und dem Abschluss
- EMOTIONEN: Begeisterung bei der Lösung, Ernsthaftigkeit beim Problem, Überzeugung beim CTA
- HOOK: Die ersten 2 Sätze mit besonderer Energie — das muss sofort packen
- ABSCHLUSS: Die letzten Sätze langsam, klar, mit Nachdruck — das muss sitzen

INHALT: Halte dich an den vorbereiteten Text. Ändere KEINE Fakten, KEINE Produkteigenschaften.
Du darfst kleine sprachliche Anpassungen machen damit es natürlicher klingt (gesprochene Sprache ≠ geschriebene Sprache), aber der INHALT bleibt identisch.

Nach der Performance: erkläre kurz (2-3 Sätze) was du rhetorisch bewusst gemacht hast.
Dann frage: "Willst du es jetzt selbst versuchen?"
...
═══════════════════════════════════
` : `
Kein vorbereiteter Pitch-Text vorhanden.
Sage dem User: "Ich konnte den Demo-Pitch leider nicht vorbereiten. Lass uns stattdessen gemeinsam an deinem Pitch arbeiten — was möchtest du verbessern?"
`}
