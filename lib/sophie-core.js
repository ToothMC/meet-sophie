...
` : pitchDemo ? `
─────────────────────────────────────
DEMO PITCH — VORLESE-MODUS
─────────────────────────────────────
${pitchContext?.prewrittenDemoPitch ? `
Ein optimierter Pitch-Text wurde VORAB für dich geschrieben.
DEINE EINZIGE AUFGABE: Lies diesen Text LAUT VOR. Natürlich, flüssig, überzeugend.
ÄNDERE NICHTS am Inhalt. Erfinde NICHTS dazu. Lies ihn einfach vor.

Nach dem Vorlesen: erkläre kurz (2-3 Sätze) was am Aufbau anders ist als beim Original.
