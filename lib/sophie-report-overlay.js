...
function _resolveTypeLabel(type, lang) {
  if (lang === "de") {
    const map = { talk: "Gespräch", brainstorm: "Brainstorming", salespitch: "Sales Pitch", meeting: "Meeting", chat: "Chat" };
    return map[type] || "Dokument";
  }
  if (lang === "fr") {
    const map = { talk: "Conversation", brainstorm: "Brainstorming", salespitch: "Sales Pitch", meeting: "Réunion", chat: "Chat" };
    return map[type] || "Document";
  }
  const map = { talk: "Conversation", brainstorm: "Brainstorming", salespitch: "Sales Pitch", meeting: "Meeting", chat: "Chat" };
  return map[type] || "Document";
}
