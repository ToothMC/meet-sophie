...
export const OTP_LABELS = {
  en: {
    codeSent: (email) => `I sent a 6-digit code to ${email}. Enter it here:`,
  ...
  de: {
    codeSent: (email) => `Ich habe einen 6-stelligen Code an ${email} geschickt. Gib ihn hier ein:`,
    codePlaceholder: "000000",
  ...
  fr: {
    codeSent: (email) => `J'ai envoyé un code à 6 chiffres à ${email}. Entre-le ici :`,
    codePlaceholder: "000000",
    verifyBtn: "Vérifier",
