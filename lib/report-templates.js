...
<div class="meeting-protocol" style="font-family:'Helvetica Neue',Helvetica,Arial,sans-serif;max-width:780px;margin:0 auto;padding:60px 72px;color:#1a1a1a;line-height:1.6;background:#fff;box-sizing:border-box;">
  ...
  <div style="background:#f8f8f8;border-radius:16px;padding:28px;margin-bottom:28px;">
    ...
    <div style="margin-top:8px;font-size:11px;color:#aaa;font-style:italic;">${t.pitchVoiceNote}</div>
  </div>

  <div style="margin-bottom:28px;">
    <h2 style="font-size:13px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#111;margin:0 0 14px;">${t.pitchStrengths}</h2>
    <div style="display:flex;flex-direction:column;gap:8px;">
      <div style="padding:12px 16px;background:#f0fdf4;border-radius:10px;border-left:3px solid #22c55e;font-size:14px;color:#333;">${t.pitchStrength1}</div>
      <div style="padding:12px 16px;background:#f0fdf4;border-radius:10px;border-left:3px solid #22c55e;font-size:14px;color:#333;">${t.pitchStrength2}</div>
    </div>
  </div>

  <div style="margin-bottom:28px;">
    <h2 style="font-size:13px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#111;margin:0 0 14px;">${t.pitchWeaknesses}</h2>
    <div style="display:flex;flex-direction:column;gap:8px;">
      <div style="padding:12px 16px;background:#fffbeb;border-radius:10px;border-left:3px solid #eab308;font-size:14px;color:#333;">${t.pitchWeakness1}</div>
      <div style="padding:12px 16px;background:#fffbeb;border-radius:10px;border-left:3px solid #eab308;font-size:14px;color:#333;">${t.pitchWeakness2}</div>
    </div>
  </div>

  <div style="background:#111;border-radius:14px;padding:24px;margin-bottom:28px;">
    <div style="font-size:11px;font-weight:700;letter-spacing:0.15em;text-transform:uppercase;color:#888;margin-bottom:8px;">${t.pitchRecommendation}</div>
    <div style="font-size:16px;color:#fff;line-height:1.7;">${t.pitchRecommendationText}</div>
  </div>

  <div style="margin-top:40px;padding-top:16px;border-top:1px solid #eee;font-size:11px;color:#bbb;text-align:center;">${t.pitchFooter}</div>
</div>`,
  ...
  <div style="margin-bottom:36px;">
    ...
    <h1 style="font-size:26px;font-weight:700;color:#111;margin:8px 0 4px;letter-spacing:-0.02em;">${t.brainstormTopic}</h1>
    <div style="font-size:14px;color:#888;">${t.brainstormMeta}</div>
  </div>

  <div style="background:#faf5ff;border-radius:14px;padding:20px 24px;margin-bottom:32px;border:1px solid #e9d5ff;">
    <div style="font-size:12px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#8b5cf6;margin-bottom:8px;">${t.brainstormCoreQuestion}</div>
    <div style="font-size:16px;color:#333;line-height:1.7;">${t.brainstormCoreQuestionText}</div>
  </div>

  <div style="margin-bottom:36px;">
    <h2 style="font-size:13px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#8b5cf6;margin:0 0 16px;">${t.brainstormClusters}</h2>
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;">
      <div style="background:#f8f8f8;border-radius:12px;padding:18px;border:1px solid #eee;">
        <div style="font-size:11px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#888;margin-bottom:10px;">${t.brainstormCluster} 1]</div>
        <div style="display:flex;flex-direction:column;gap:6px;">
          <div style="padding:8px 12px;background:#fff;border-radius:8px;font-size:13px;color:#333;border:1px solid #eee;">${t.brainstormIdea} 1.1]</div>
          <div style="padding:8px 12px;background:#fff;border-radius:8px;font-size:13px;color:#333;border:1px solid #eee;">${t.brainstormIdea} 1.2]</div>
          <div style="padding:8px 12px;background:#fff;border-radius:8px;font-size:13px;color:#333;border:1px solid #eee;">${t.brainstormIdea} 1.3]</div>
        </div>
      </div>
      <div style="background:#f8f8f8;border-radius:12px;padding:18px;border:1px solid #eee;">
        <div style="font-size:11px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#888;margin-bottom:10px;">${t.brainstormCluster} 2]</div>
        <div style="display:flex;flex-direction:column;gap:6px;">
          <div style="padding:8px 12px;background:#fff;border-radius:8px;font-size:13px;color:#333;border:1px solid #eee;">${t.brainstormIdea} 2.1]</div>
          <div style="padding:8px 12px;background:#fff;border-radius:8px;font-size:13px;color:#333;border:1px solid #eee;">${t.brainstormIdea} 2.2]</div>
        </div>
      </div>
      <div style="background:#f8f8f8;border-radius:12px;padding:18px;border:1px solid #eee;">
        <div style="font-size:11px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#888;margin-bottom:10px;">${t.brainstormCluster} 3]</div>
        <div style="display:flex;flex-direction:column;gap:6px;">
          <div style="padding:8px 12px;background:#fff;border-radius:8px;font-size:13px;color:#333;border:1px solid #eee;">${t.brainstormIdea} 3.1]</div>
          <div style="padding:8px 12px;background:#fff;border-radius:8px;font-size:13px;color:#333;border:1px solid #eee;">${t.brainstormIdea} 3.2]</div>
          <div style="padding:8px 12px;background:#fff;border-radius:8px;font-size:13px;color:#333;border:1px solid #eee;">${t.brainstormIdea} 3.3]</div>
        </div>
      </div>
      <div style="background:#f8f8f8;border-radius:12px;padding:18px;border:1px solid #eee;">
        <div style="font-size:11px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#888;margin-bottom:10px;">${t.brainstormCluster} 4]</div>
        <div style="display:flex;flex-direction:column;gap:6px;">
          <div style="padding:8px 12px;background:#fff;border-radius:8px;font-size:13px;color:#333;border:1px solid #eee;">${t.brainstormIdea} 4.1]</div>
          <div style="padding:8px 12px;background:#fff;border-radius:8px;font-size:13px;color:#333;border:1px solid #eee;">${t.brainstormIdea} 4.2]</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="margin-bottom:32px;">
    <h2 style="font-size:13px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#8b5cf6;margin:0 0 14px;">${t.brainstormFavorites}</h2>
    <div style="display:flex;flex-direction:column;gap:8px;">
      <div style="display:flex;align-items:center;gap:12px;padding:14px 18px;background:linear-gradient(135deg,#faf5ff,#f0e7ff);border-radius:10px;border:1px solid #e9d5ff;">
        ...
        <div>
          <div style="font-size:14px;font-weight:600;color:#111;">${t.brainstormFav1}</div>
          <div style="font-size:12px;color:#666;margin-top:2px;">${t.brainstormFav1Why}</div>
        </div>
      </div>
      <div style="display:flex;align-items:center;gap:12px;padding:14px 18px;background:#f8f8f8;border-radius:10px;border:1px solid #eee;">
        ...
        <div>
          <div style="font-size:14px;font-weight:600;color:#111;">${t.brainstormFav2}</div>
          <div style="font-size:12px;color:#666;margin-top:2px;">${t.brainstormFav2Why}</div>
        </div>
      </div>
      <div style="display:flex;align-items:center;gap:12px;padding:14px 18px;background:#f8f8f8;border-radius:10px;border:1px solid #eee;">
        <div style="font-size:20px;font-weight:800;color:#bbb;">3</div>
        <div>
          <div style="font-size:14px;font-weight:600;color:#111;">${t.brainstormFav3}</div>
          <div style="font-size:12px;color:#666;margin-top:2px;">${t.brainstormFav3Why}</div>
        </div>
      </div>
    </div>
  </div>
  ...
  <div style="margin-bottom:32px;">
    <h2 style="font-size:13px;font-weight:700;letter-spacing:0.1em;text-transform:uppercase;color:#8b5cf6;margin:0 0 14px;">${t.brainstormNextSteps}</h2>
    <div style="display:flex;flex-direction:column;gap:6px;">
      <div style="padding:10px 16px;background:#f8f8f8;border-radius:8px;font-size:14px;color:#333;border-left:3px solid #8b5cf6;">${t.brainstormStep1}</div>
      <div style="padding:10px 16px;background:#f8f8f8;border-radius:8px;font-size:14px;color:#333;border-left:3px solid #8b5cf6;">${t.brainstormStep2}</div>
    </div>
  </div>

  <div style="margin-top:40px;padding-top:16px;border-top:1px solid #eee;font-size:11px;color:#bbb;text-align:center;">${t.brainstormFooter}</div>
</div>`,
  };
}

/** @deprecated Use getDefaultTemplates(lang) instead. Kept for backward compatibility. */
export const DEFAULT_TEMPLATES = getDefaultTemplates('de');
