 ...
 */
export function renderScorecardReport(data) {
  const contextLines = [
    data.situation && `<strong>Situation:</strong> ${data.situation}`,
    data.goal && `<strong>Ziel:</strong> ${data.goal}`,
    data.mainProblem && `<strong>Hauptproblem:</strong> ${data.mainProblem}`,
  ].filter(Boolean);
