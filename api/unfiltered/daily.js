...
export default async function handler(req, res) {
  ...
  try {
    ...
    // Wenn aus dünnen/leeren Crawler-Resultaten nichts gekommen ist, NICHT
    // im Cache speichern — sonst bleibt der Müll bis Mitternacht stehen
    // und blockiert spätere Versuche. Stattdessen ehrlich an Sophie melden.
